...
export const Superiority = () => {
  return (
    <Box display={'flex'} justifyContent={'center'} alignItems={'center'} gap={'30px'} h={'300px'}>
        <Box w={'20%'} display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
            <Box bg={'#C1C0C1'} p={'10px'} rounded={'100%'} w={'40%'}>
